...
#include "WoodaxePickup.generated.h"

class UStaticMeshComponent;
class AFPSCharacter;

UCLASS()
class BYTHENIGHT_API AWoodaxePickup : public AActor, public IInteractable
{
    GENERATED_BODY()
...
protected:
    ...
    UStaticMeshComponent* WoodaxeMesh;

    // Configurable data
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Interaction")
    FString InteractionPromptText = TEXT("Press [E] to pick up woodaxe");
